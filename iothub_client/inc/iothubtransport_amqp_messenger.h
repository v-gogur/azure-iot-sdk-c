...
extern "C"
{
	...
	MOCKABLE_FUNCTION(, int, messenger_subscribe_for_messages, MESSENGER_HANDLE, messenger_handle, ON_MESSAGE_RECEIVED, on_message_received_callback, void*, context);
